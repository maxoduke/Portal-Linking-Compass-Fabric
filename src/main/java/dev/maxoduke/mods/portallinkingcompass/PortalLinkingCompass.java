...
public class PortalLinkingCompass
{
    ...
    public static final ResourceLocation LINKED_PORTAL_TRACKER_COMPONENT_RESOURCE = ResourceLocation.fromNamespaceAndPath(PortalLinkingCompass.MOD_ID, PortalLinkingCompass.LINKED_PORTAL_TRACKER_COMPONENT_NAME);
    ...
    public static final ResourceLocation ITEM_RESOURCE = ResourceLocation.fromNamespaceAndPath(PortalLinkingCompass.MOD_ID, PortalLinkingCompass.ITEM_NAME);
